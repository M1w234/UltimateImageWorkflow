    ...
    <div className="space-y-6">
      <div className="bg-blue-500/10 border border-blue-500/30 rounded-lg p-4">
        <p className="text-blue-300 text-sm">
          <strong>Multi-Edit Mode:</strong> Upload multiple images and apply the same edit prompt to all of them. 
          ...
          >
                  ...
                  {slot.images.map((img, imgIdx) => (
                    <div key={img.id} className="relative group">
                      <img
                        src={img.preview}
                        alt={img.fileName}
                        className="w-16 h-16 object-cover rounded-lg border border-slate-600 cursor-pointer hover:border-blue-500"
            ...
            <div className="space-y-3">
              <textarea
                ...
                className="w-full bg-slate-900 text-white rounded-lg p-3 border border-slate-600 focus:border-blue-500 focus:outline-none resize-none h-20 text-sm"
              />
